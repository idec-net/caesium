...
class Reader(metaclass=Group):
    ...
    LEFT = Cmd("прокрутка влево")
    LEFTP = Cmd("страница влево ")
    RIGHT = Cmd("прокрутка вправо")
    RIGHTP = Cmd("страница вправо")
    PPAGE = Cmd("страница вверх")
    NPAGE = Cmd("страница вниз")
    ...
    QUOTE_NOT = Cmd("ответить с цитированием (старый стиль)")
    ...
    HSCROLL = Cmd("вкл/выкл горизонтальный скролл")
