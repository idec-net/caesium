...
Файл caesium.cfg очень прост по своей структуре и содержит всего несколько параметров:
  ...
  * db - формат базы сообщений (txt, aio, ait или sqlite; настоятельно рекомендуется формат ait)
  ...
  * horizontalScroll - не делать переносы строк в широких блоках кода, а добавлять горизонтальную прокрутку  
...
Экран чтения эхоконференции:
  ...
  * Shift+Курсор влево/Курсор вправо - горизонтальная прокрутка при наличии широких блоков кода, 1 символ  
  * Alt+Курсор влево/Курсор вправо - горизонтальная прокрутка при наличии широких блоков кода, страница
  ...
  * Shift+Q - ответить на текущее сообщение с цитированием в старом формате (или в новом, если включен 'oldqoute' в конфиге)
