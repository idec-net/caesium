...
s.DOWN.ks =    ["Down"]  # noqa: E222  курсор вниз
s.PPAGE.ks =   ["PgUp"]  # noqa: E222  страница вверх
s.NPAGE.ks =   ["PgDn"]  # noqa: E222  страница вниз
s.HOME.ks =    ["Home"]  # noqa: E222  в начало
s.END.ks =     ["End"]  # noqa: E222  в конец
s.GET.ks =     ["g"]  # noqa: E222  получить сообщения (свежие по счётчику)
s.FGET.ks =    ["C-g"]  # noqa: E222  получить сообщения (полный индекс)
s.ARCHIVE.ks = ["Tab"]  # noqa: E222  переключение в архив и обратно
s.ENTER.ks =   ["RET", "Right", "SPC"]  # noqa: E222  открыть эху
s.OUT.ks =     ["o"]  # noqa: E222  исходящие сообщения
s.DRAFTS.ks =  ["d"]  # noqa: E222  черновики
s.NNODE.ks =   ["."]  # noqa: E222  следующая нода
s.PNODE.ks =   [","]  # noqa: E222  предыдущая нода
s.CONFIG.ks =  ["e"]  # noqa: E222  редактировать конфиг
s.FIND.ks =    ["y"]  # noqa: E222  открыть окно поиска по БД

# Клавиши для экрана чтения
r.PREV.ks =      ["Left"]  # noqa: E222  предыдущее сообщение
r.NEXT.ks =      ["Right"]  # noqa: E222  следующее сообщение
r.PREP.ks =      ["-"]  # noqa: E222  перейти ниже по цепочке ответов
r.NREP.ks =      ["="]  # noqa: E222  вернуться по цепочке ответов
r.UP.ks =        ["Up"]  # noqa: E222  прокрутка вверх
r.DOWN.ks =      ["Down"]  # noqa: E222  прокрутка вниз
r.LEFT.ks =      ["S-Left"]  # noqa: E222  прокрутка влево
r.LEFTP.ks =     ["M-Left"]  # noqa: E222  страница влево
r.RIGHT.ks =     ["S-Right"]  # noqa: E222  прокрутка вправо
r.RIGHTP.ks =    ["M-Right"]  # noqa: E222  страница вправо
...
r.INS.ks =       ["i", "Ins"]  # noqa: E222  добавить сообщение
r.SAVE.ks =      ["w"]  # noqa: E222  сохранить сообщение в файл
r.FAVORITES.ks = ["f"]  # noqa: E222  добавить сообщение в избранные
r.QUOTE.ks =     ["q"]  # noqa: E222  ответить с цитированием
r.QUOTE_NOT.ks = ["S-q"]  # noqa: E222  ответить с цитированием (старый формат)
r.INFO.ks =      ["m"]  # noqa: E222  показать msgid, адрес, тему сообщения в отдельном окне
r.LINKS.ks =     ["v"]  # noqa: E222  работа со ссылками
r.GETMSG.ks =    ["g"]  # noqa: E222  получить текущее сообщение с ноды
r.TO_OUT.ks =    ["o"]  # noqa: E222  перенести неотправленное исходящее сообщение в черновики
r.TO_DRAFTS.ks = ["d"]  # noqa: E222  перенести черновик в исходящие сообщения
r.LIST.ks =      ["l"]  # noqa: E222  список сообщений
r.INLINES.ks =   ["z"]  # noqa: E222  вкл/выкл поддержку inline-оформления
r.HSCROLL.ks =   ["S-z"]  # noqa: E222  вкл/выкл горизонтальный скролл
r.MSUBJ.ks =     ["!"]  # noqa: E222  вкл/выкл просмотр сообщений по теме
r.QUIT.ks =      ["ESC"]  # noqa: E222  вернуться на экран выбора эхоконференции

# Клавиши для просмотра исходящих и черновиков
o.EDIT.ks = ["e"]  # редактировать сообщение
o.SIGN.ks = ["M-s"]  # подписать сообщение PGP-ключом
o.DEL.ks = ["Del"]  # удалить черновик/исходящее/избранное

# Клавиши быстрого поиска
qs.OPEN.ks =  ["s"]  # noqa: E222  открыть текстовое поле быстрого поиска
